...
public class ConversionGUI {
    ...
    String conversionTypesArray[] = {"Area", "Length", "Temperature", "Mass", "Volume"};
    ...
    public ConversionGUI() {
        ...
        CyclingSpinnerListModel volumeTypesModel = new CyclingSpinnerListModel(volumeTypesArray);
        CyclingSpinnerListModel volumeTypesModel2 = new CyclingSpinnerListModel(volumeTypesArray2);

        CyclingSpinnerListModel massTypesModel = new CyclingSpinnerListModel(massTypesArray);
        CyclingSpinnerListModel massTypesModel2 = new CyclingSpinnerListModel(massTypesArray2);
        ...
        conversionTypeSpinner.addChangeListener(new
                                                        ChangeListener() {
                                                            ...
                                                            public void stateChanged(ChangeEvent e) {
                                                                ...
                                                                //  ToDO: Add your code else ifs for Mass and Volume
                                                                else if (conversionTypeSpinner.getValue().equals("Volume")) {
                                                                    conversionSelectionA.setModel(volumeTypesModel);
                                                                    conversionSelectionB.setModel(volumeTypesModel2);
